...
- [ Outdated? ] Explore the ways to automate test the hub with or without mocking.
...
## 2023-09-19
- [X] Watch a video from RedHat on design and documenting. (A development team shares their method of design)
- [X] Do a brainstorm on a shared tool
- [X] Research how to generate a UML / class diagram from existing (C#) code.
- [X] Answer the question, how do you keep diagrams in sync with code as a project goes on.
...
## 2023-09-26
- We watched a short video about Event Storming: https://www.youtube.com/watch?v=Y7NzXl-ahtU
...
## 2023-11-28
- We started coding the Lobby aggregate with TDD, and adding folders to the VS solution for each aggregate so far, i.e., 
  Room and Lobby.
- [X] When user sees existing rooms, how will they differentiate them, e.g., maybe a room name (supplied or autogenerated)
	  and/or who is in the room (if any users are in the room so far). 
      (See empty test NextUserSeesExistingRooms_MaybeRoomNamesAndOrUsersInTheRoom in LobbyTest.cs file)

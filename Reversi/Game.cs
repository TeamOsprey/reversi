...
namespace Reversi.Logic
{
    public class Game
    {
        ...
        private void CaptureCounters(Square selectedSquare)
        {
            ...
            {
                if (IsNextPositionValid(selectedSquare, returnValue, direction))
                    break;
            }*/
            int i = 1;
            while(ReversiBoard.BoardPosition[selectedSquare.Row + i, selectedSquare.Column] != TurnColor)
            {
                ReversiBoard.BoardPosition[selectedSquare.Row + i, selectedSquare.Column] = TurnColor;
                i++;
            }
        }
